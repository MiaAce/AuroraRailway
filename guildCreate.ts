...
const clientReady: Event = {
    ...
    async execute(client: Client) {
        ...
        await gatewayStability(client); // await guilds to be available

        /* UNCOMMENT ONLY IF THERE IS AT LEAST ONE CRON TASK IMPLEMENTED
        // cron tasks
        ...
        */
        ...
        /* UNCOMMENT ONLY IF THERE IS AT LEAST ONE EVENT HOOK IMPLEMENTED
